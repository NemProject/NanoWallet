function GermanProvider($translateProvider) {
    ...
    $translateProvider.translations('de', {
        ...
        GENERAL_SUB_NAMESPACES: 'Sub-Namensräume',
        GENERAL_SUB_NAMESPACE: 'Sub-Namensraum',
        ...
        LINE_TX_DETAILS_NS_NEW_SUB: 'Sub-Namensraum erstellen',
        ...
        MOSAIC_DEFINITION_INFORMATION: 'Wollen Sie mehr über Mosaiks wissen?',
        MOSAIC_DEFINITION_INFORMATION_1: 'Die maximale Länge für ein Mosaik Name sind 32 Zeichen. Erlaubte Zeichen sind:',
        MOSAIC_DEFINITION_INFORMATION_2: 'Das erste Zeichen muss ein Buchstabe des Alphabets sein.',
        MOSAIC_DEFINITION_INFORMATION_3: 'Die Beschreibung darf eine Länge von 512 Zeichen nicht überschreiten. Es gibt keine Einschränkung für die in der Beschreibung verwendeten Zeichen.',
        MOSAIC_DEFINITION_INFORMATION_4: 'Das Verhalten eines Mosaiks kann durch eine Reihe von Eigenschaften angepasst werden:',
        MOSAIC_DEFINITION_INFORMATION_5: 'Die Bereitstellung erfolgt in ganzen Einheiten des Mosaiks, nicht in kleinsten Untereinheiten. Die Erstlieferung muss im Bereich von 0 und 9.000.000.000 liegen.',
        MOSAIC_DEFINITION_INFORMATION_6: 'Die Teilbarkeit bestimmt bis zu welcher Dezimalstelle das Mosaik aufgeteilt werden kann. So bedeutet eine Teilbarkeit von 3, dass ein Mosaik in kleinste Teile von 0,001 Mosaiken unterteilt werden kann, d.h. Milli-Mosaiken ist die kleinste Untereinheit. Die Teilbarkeit muss im Bereich von 0 und 6 liegen.',
        MOSAIC_DEFINITION_INFORMATION_7: 'Wenn angehakt, erlaubt es eine Mosaikbereitstellungsänderung zu einem späteren Zeitpunkt, ansonsten ist die Versorgung unveränderlich.',
        MOSAIC_DEFINITION_INFORMATION_8: 'Erlaube Transfers des Mosaiks unter Konten außer dem Ersteller. Wenn die Eigenschaft \'Übertragbar\' nicht angehakt ist, können nur Transaktionen mit dem Ersteller als Absender oder als Empfänger von Mosaiken dieser Art übertragen. Wenn angehakt, können die Mosaiken auf und von beliebigen Konten übertragen werden.',
        MOSAIC_DEFINITION_INFORMATION_9: 'Der Ersteller kann verlangen, dass eine Sondergebühr vom Absender erhoben und auf ein Konto seiner Wahl geschickt wird (so kann der Ersteller sein eigenes Konto als Empfänger dieser Gebühren angeben). Die Daten für die Abgaben (levy) sind folgende:',
        ...
        MOSAIC_DEFINITION_INFORMATION_11: 'Der Empfänger der Abgaben. Dies kann ein beliebiges Konto sein.',
        MOSAIC_DEFINITION_INFORMATION_12: 'Die Gebührenmenge. Die Interpretation ist abhängig vom Feld \'Gebührenart\', siehe darüber.',
        MOSAIC_DEFINITION_INFORMATION_13: 'Es werden 2 Arten von Gebühren unterstützt, absolute Gebühren und prozentuale Gebühren.',
        MOSAIC_DEFINITION_INFORMATION_14: 'Die Gebühr wird als absolute Menge angegeben und hängt also nicht von der übertragenen Menge ab.',
        MOSAIC_DEFINITION_INFORMATION_15: 'Die Gebühr wird als Vielfaches des Perzentils der übertragenen Menge angegeben. Die Gebühr steigt also linear mit der übertragenen Mosaikmenge.',
        MOSAIC_DEFINITION_INFORMATION_16: 'Das Versenden von Mosaiken auf der NEM blockchain erfordert eine Gebühr. Die genaue Gebühr wird in Abhängigkeit von ihrer Gesamtzahl und wie viele während einer Transaktion gesendet werden berechnet. <b>Small business Mosaike</b> erhalten eine vergünstigte Flatrate von 1 XEM pro Mosaik pro Transfer. Dies sind Mosaiken mit einer Menge von weniger als 10.000 und eine Teilbarkeit von 0.',
        ...
        NAMESPACE_PROVISION_PARENT: 'Root-Namensraum',
        ...
        NAMESPACE_PROVISION_INFORMATION_1: 'Namensräume haben gewisse Einschränkungen in Bezug auf die Zeichen, die in den Teilen erlaubt sind, sowie die Länge eines Teils. Ein Root-Namensraum kann eine Länge von 16 Zeichen haben, während Sub-Namensräume eine Länge von 64 Zeichen haben können. Gültige Zeichen sind:',
        NAMESPACE_PROVISION_INFORMATION_2: 'Ein Teil darf aber nur mit einem Buchstaben des Alphabets beginnen, also \'alice\' ist ein erlaubter Teil für einen Root-Namensraum während \'1alice\' nicht erlaubt ist. Bestimmte Zeichenketten sind reserviert und somit nicht als Namespace-Teile erlaubt. Unter den unzulässigen Namensraum-Teilen sind:',
        NAMESPACE_PROVISION_INFORMATION_3: 'Diese Liste ist nicht endgültig und kann in Zukunft erweitert werden. \'user.alice\' oder \'alice.user\' sind im NEM Namensraum-System nicht erlaubt. Der Namespace kann bis zu 3 Teile haben, daher ist \'qm.metals.silver\' gültig, während \'qm.metals.silver.coin\' ungültig ist.',
        ...
        PORTAL_NS_TITLE: 'Namensräume & Subd-Namensräume',
        ...
        APOSTILLE_HISTORY_TITLE: 'Apostillen Historie',
        ...
        APOSTILLE_CREATE_TITLE: 'Apostille erstellen',
        APOSTILLE_CREATE_HELP: 'Wollen Sie mehr über Apostillen erfahren?',
        APOSTILLE_TRANSACTION_NAME: 'Apostille-Transaktion',
        APOSTILLE_TRANSACTION_MULTISIG_NAME: 'Multi-Signatur Apostille-Transaktion',
        APOSTILLE_KEEP_PRIVATE: 'Privat, übertragbar und aktualisierbar',
        APOSTILLE_USE_DEDICATED: '',
        APOSTILLE_FILES_TO_NOTARIZE: 'Dateien zu notarisieren',
        APOSTILLE_REJECTED: 'Abgelehnt',
        APOSTILLE_FILE_HASH: 'Datei hash',
        APOSTILLE_PRIVATE: 'Privat',
        APOSTILLE_FILENAME: 'Dateiname',
        APOSTILLE_NAME_TOO_LONG: 'Dateiname ist zu lang, 32 Zeichen sind maximal erlaubt.',
        APOSTILLE_MAX_NUMBER: 'Maximale Apostillen pro Ladung ist 25',
        APOSTILLE_INFORMATION_TITLE: 'Erstelle eine Apostille',
        APOSTILLE_INFORMATION_1: 'Jede hochgeladene Datei wird automatisch mit den Optionen die auf der linken Seite eingestellt sind verarbeitet. Sie können neue Dateien hinzufügen, Parameter ändern und dann weitere Dateien mit anderen Optionen hinzufügen. Es funktioniert auch, wenn Sie auf den Multisignatur-Reiter wechseln und weitere Dateien hinzufügen.',
        APOSTILLE_INFORMATION_2: '"<b>Private, übertragbare und aktualisierbare'</b>" Einstellung bedeutet, das die Hashes Ihrer Dateien mit Ihrem privaten Schlüssel signiert und an ein dediziertes hierarchisches deterministisches (HD) Konto gesendet werden. Auf diese Weise ist es für niemanden außer Ihnen möglich zu wissen welcher Inhalt zeitgestempelt wurde, es sei denn Sie teilen den Inhalt.',
        APOSTILLE_INFORMATION_3: 'Das dedizierte HD-Konto kann unter ein Multisignatur-Vertrag gesetzt werden, damit es zu anderen übertragen werden kann über 1-zu-1 oder jeder m-zu-n Multisignatur-Vertrags Kombination. Es kann auch zusätzliche Informationen an ihn über Nachrichten gesendet, mit Updates und Ergänzungen an das Originaldokument oder das Produkt, das es darstellt, übermittelt werden.',
        APOSTILLE_INFORMATION_4: 'Wenn zwei oder mehr Parteien beide einen Blockchain-Zeitstempel genehmigen möchten, z.B. verbindliche Verträge, kann das Konto, das die Blockchain-Notarisierung vornimmt in ein Multisignatur-Vertrag gesetzt werden.',
        APOSTILLE_INFORMATION_5: 'Für Konten in einem Multisignatur-Vertrag, die "<b>Privat, übertragbar, and aktualisierbar</b>" gewählt haben, wird der private Schlüssel des initiierenden Mitunterzeichners verwendet, um den Hash zu signieren und ein dediziertes HD-Konto zu erstellen, nicht das Konto das multisigniert wurde.',
        APOSTILLE_INFORMATION_6: 'Das HD-Konto ist ein dediziertes Konto, das aus einem Hash des Dateinamens generiert wird, das dann von Ihrem privaten Schlüssel signiert wird. Dieser resultierende Hash dieses Prozesses wird dann verwendet, um einen zweiten privaten Schlüssel zu bilden.  Dies ist der private Schlüssel der Zeitstempel-Datei; der erste in der Blockchain-Technologie, den es nur in Apostille gibt.',
        APOSTILLE_INFORMATION_7: 'Mit dem dedizierten HD-Konto können Sie den signierten Hash und die Updates der originalen Datei auf einem dedizierten Account speichern. Wenn <b>"Öffentlich"</b> gewählt ist, geht die Transaktion an die öffentliche Sinkadresse (Standard).',
        APOSTILLE_INFORMATION_8: 'Nach dem Senden der Transaktionen wird der Download eines Archivs gestartet. Es enthält Ihre signierten Dateien, Ihr Apostille Zertifikat für diese Datei und die neue oder aktualisierte .nty Datei, um jede Datei verfolgen zu können, die Sie auf der NEM Blockchain zeitgestempelt haben.',
        APOSTILLE_NO_NTY: 'Keine nty Datei geladen, klicken Sie bitte hier um eine Datei zu importieren, oder es wird autpoatisch eine neue erzeugt.',
        APOSTILLE_IMPORT_FILES: 'Importiere Dateien',
        APOSTILLE_CREATE_TEXT: 'Erstelle Text Dokument',
        APOSTILLE_ENTER_TEXT: 'Text zum notarisieren eingeben...',
        APOSTILLE_DOCUMENT_TITLE: 'Dokument Titel',
        APOSTILLE_DROPBOX_MESSAGE: 'Bitte geben Sie Ihr Passwort und gewünschte Tag(s) ein, bevor Sie Dateien auswählen',
        APOSTILLE_DROPBOX_MESSAGE_2: 'Bitte geben Sie Ihr Passwort ein, bevor Sie Dateien auswählen',

        // AUDIT APOSTILLE MODULE
        APOSTILLE_AUDIT_TITLE: 'Apostillen auditieren',
        APOSTILLE_AUDIT_CHOOSE_NODE: 'Wähle einen Knoten',
        APOSTILLE_AUDIT_CHOOSE_NODE_NOTE: 'Nur wenige Knoten können in der gesamten Transaktionshistorie suchen (Option ist in NIS standardmäßig deaktiviert).', //
        APOSTILLE_AUDIT_WRONG_FORMAT: 'Diese Datei ist nicht im Apostille-Format !',
        ...
        APOSTILLE_AUDIT_WAITING: 'Apostillen Übertragung könnte auf Bestätigung warten !',
        APOSTILLE_AUDIT_NOT_FOUND: 'Transaktion nicht gefunden, stellen Sie sicher, dass es nicht auf Bestätigungen wartet, ansonsten ist das Apostille ungültig',
        APOSTILLE_AUDIT_ERROR_UNCONFIRMED: 'Beim Abrufen von unbestätigten Daten ist ein Fehler aufgetreten, aber Transaktion wurde nicht gefunden',
        APOSTILLE_AUDIT_ERROR_SIGNER: 'Beim Abrufen von Unterzeichner-Daten ist ein Fehler aufgetreten',
        APOSTILLE_AUDIT_ERROR_SIGNATURE: 'Überprüfung fehlgeschlagen, bei der Signaturüberprüfung ist ein Fehler aufgetreten !',
        APOSTILLE_AUDIT_INFORMATION_1: 'Dateien, die geprüft werden können, müssen im  <b>Apostillen format</b> vorliegen',
        APOSTILLE_AUDIT_INFORMATION_2: 'Sie können sie am Dateinamen erkennen:',
        //APOSTILLE_AUDIT_NON_SIGNED: 'Non signed exemple:',
        //APOSTILLE_AUDIT_SIGNED: 'Signed exemple:',
        APOSTILLE_AUDIT_FILES: 'Dateien auditieren',

        // APOSTILLE MESSAGE MODULE
        APOSTILLE_MESSAGE_TITLE: 'Nachricht an Notarisierungskonto senden',
        APOSTILLE_MESSAGE_NS_BRAND: 'Benutze meinen Namensraum um die Nachricht zu markieren',
        APOSTILLE_MESSAGE_ADD_MOSAIC: 'Mosaik hinzufügen',
        APOSTILLE_NTY_ACCOUNT: 'Notarisierungskonto',
        APOSTILLE_REQUEST_MESSAGE: 'Eine Nachricht anfordern',
        APOSTILLE_CREATE_MESSAGE_REQUEST: '',

        // TRANSFER APOSTILLE OWNLERSHIP MODULE
        APOSTILLE_TRANSFER_TITLE: 'Apostillen Besitz übertragen oder aufteilen',
        ...
        ALERT_COSIGNATORY_HAS_NO_PUBLIC: 'Das Mitunterzeichner Konto muss mindestens eine ausgehende Transaktion tätigen um einen öffentlichen Schlüssel zu erhalten !',
        ALERT_MULTISIG_HAS_NO_PUBLIC: 'Das Multi-Signatur Konto muss mindestens eine ausgehende Transaktion tätigen um einen öffentlichen Schlüssel zu erhalten !',
        ...
        // VOTING MODULE
        PORTAL_VOTING_TITLE: 'Umfragen',
        PORTAL_VOTING_TEXT: 'Erstellung uns Abstimmungen von Umfragen',
        PORTAL_VOTING_BTN1: 'Umfragen anzeigen',
        PORTAL_VOTING_BTN2: 'Umfrage erstellen',
        FORM_TITLE_FIELD_PLACEHOLDER: 'Titel',
        FORM_DESCRIPTION_FIELD_PLACEHOLDER: 'Schreiben Sie hier Ihre Beschreibung',
        FORM_OPTION_FIELD_PLACEHOLDER: 'Schreibe Option',
        FORM_WHITELIST_FIELD_PLACEHOLDER: 'Kontoadresse'
    });
