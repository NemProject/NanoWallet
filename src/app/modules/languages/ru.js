function RussianProvider($translateProvider) {
    ...
    $translateProvider.translations('ru', {
        ...
        ALERT_MULTISIG_MIN_SIGNATURE: 'Мультиподписной аккаунт требует миниммум одну подпись',
        ...
        SIGNUP_COMMON_WALLET_WARNING_TITLE: 'Предупреждения о безопасности учётной записи',
        SIGNUP_COMMON_WALLET_WARNING_1: 'Кошельки хранятся <b><u>временно</u></b> в локальном хранилище браузера! Браузеры могут быть настроены (например дополнительными расширениями) так, чтобы время от времени очищать локальное хранилище. Это приведёт к потере данных. В нашем случае ваши кошельки исчезнут, поэтому очень важно убедиться, что у Вас есть вся необходимая информация для восстановления Ваших учётных записей.',
        ...
        SIGNUP_COMMON_WALLET_WARNING_4: 'Даже если у Вас есть файл кошелька, <b><u>обязательно</u></b> сделайте резервную копию приватного ключа Вашей учётной записи. Нажмите кнопку ниже, чтобы показать его:',
