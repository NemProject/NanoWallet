function RussianProvider($translateProvider) {
    ...
    $translateProvider.translations('ru', {
        ...
        DASHBOARD_NOTICE_3: 'Команда NEM не несёт ответственности за любые потери средств, в связи с использованием NanoWallet в главной сети (mainnet). Мы рекомендуем, в первую очередь, ознакомиться с NanoWallet в тестовой сети (testnet). Пользователи несут ответственность за сохранность своих средств, резервных копий и приватных ключей.',
        DASHBOARD_NOTICE_4: 'Не используйте главную сеть (mainnet), если не уверены, что Ваши средства надежно защищены. Мы рекомендуем записать приватные ключи на бумаге и хранить её в безопасном месте. Кроме того, Вы можете импортировать свои аккаунты в LightWallet/NCC.',
        ...
        GENERAL_MULTISIG_ACCOUNT: 'Мультиаккаунт',
        ...
        TRANSFER_TRANSACTION_ENCRYPT_TOOLTIP_MULTISIG: 'Нет зашифрованных сообщений через мультиаккаунт',
        ...
        LINE_TX_DETAILS_MULTISIG_CREATE: 'Создание мультиаккаунта',
        LINE_TX_DETAILS_MULTISIG_EDIT: 'Редактирование мультиаккаунта',
        ...
        IMPORTANCE_TRANSFER_MULTISIGNATURE_TITLE: 'Управление делегированным аккаунтом мультиаккаунта',
        ...
        IMPORTANCE_TRANSFER_INFO_PART_MULTISIG: 'Для мультиаккаунтов, только соподписант, который инициировал операцию передачи важности, может запускать/останавливать харвестинг. Если какой-то другой соподписант желает вернуть контроль над управлением харвестингом, ему просто необходимо деактивировать/актировать харвестинг.',
        IMPORTANCE_TRANSFER_NO_BLOCKS_HARVESTED: 'Нет собранных блоков',
        IMPORTANCE_TRANSFER_HARVESTING_PANEL: 'Панель харвестинга',
        IMPORTANCE_TRANSFER_REMOTE_ACTIVATING: 'Вы должны подождать, пока удаленный статус изменится на «Активирован», чтобы начать делегированный харвестинг.',
        ...
        IMPORTANCE_TRANSFER_MULTISIG_NOT_INITIATOR: 'Вы не соподписант, который активировал удаленный аккаунт, поэтому не можете запускать/останавливать делегированный харвестинг.',
        IMPORTANCE_TRANSFER_MULTISIG_SELECT: 'Выберите мультиаккаунт',
        IMPORTANCE_TRANSFER_MULTISIG_SELECT_MESSAGE: 'Пожалуйста, выберите мультиаккаунт, чтобы показать статус',
        ...
        IMPORTANCE_TRANSFER_HARVESTING_STATUS: 'Статус харвестинга',
        IMPORTANCE_TRANSFER_START_HARVESTING: 'Старт делегированного харвестинга',
        IMPORTANCE_TRANSFER_STOP_HARVESTING: 'Стоп делегированного харвестинга',
        ...
        ACCOUNT_HARVESTING: 'Харвестинг',
        ACCOUNT_REMOTE_STATUS: 'Удаленный статус',
        ACCOUNT_DELEGATED_PUBLIC: 'Публичный ключ',
        ACCOUNT_HARVESTED_BLOCKS: 'Собранные блоки',
        ACCOUNT_START_STOP_HARVESTING: 'Старт/стоп делегированного харвестинга',
        ACCOUNT_HARVESTING_NOTE: 'Если Вы уже запускали харвестинг <b>используя NanoWallet</b> и Ваше локальное хранилище было очищено, выберите узел, который использовался, для восстановления прежнего состояния. (Ваш харвестинг не останавливался).',
        ACCOUNT_HARVESTING_NODE_SELECT: 'Выберите узел для харвестинга',
        ACCOUNT_HARVESTING_START: 'Запустить делегированный харвестинг',
        ACCOUNT_HARVESTING_STOP: 'Остановить делегированный харвестинг',
        ACCOUNT_HARVESTING_NO_SLOTS: 'Нет свободных слотов на выбранном узле, пожалуйста, выберите другой',
        ACCOUNT_HARVESTING_BELOW_THRESHOLD: 'Вам необходимо иметь 10,000 XEM на активном балансе, чтобы начать делегированный харвестинг',
        ...
        // PORTAL MODULE
        PORTAL_TITLE: 'Сервис',
        PORTAL_MULTISIG_TITLE: 'Мультиаккаунты',
        PORTAL_MULTISIG_TEXT: 'Мультиаккаунты являются редактируемыми контрактами, основанными на блокчейне. Они являются мощным средством финансовой защиты, позволяющим нескольким пользователям совместно управлять одним аккаунтом.',
        ...
        PORTAL_HARVESTING_TITLE: 'Делегированный харвестинг',
        PORTAL_HARVESTING_TEXT: 'Делегированный харвестинг позволяет «майнить», даже когда Ваш аккаунт закрыт.',
        ...
        PORTAL_MOSAIC_TEXT: 'Мозайки NEM - это активы, которые обладают определёнными свойствами и другими функциями. Чтобы иметь возможность создавать мозайки, аккаунт должен зарегистрировать хотя бы одно корневое пространство имён.',
        PORTAL_MOSAIC_BTN_1: 'Создать мозайку',
        PORTAL_MOSAIC_BTN_2: 'Редактировать мозайку',
        PORTAL_APOSTILLE_TITLE: 'Apostille',
        PORTAL_APOSTILLE_TEXT: 'Используйте сервис NEM Apostille для создания нотариальных заверений на основе блокчейн технологии, например для передачи права собственности и проверки документов.',
        ...
        APOSTILLE_INFORMATION_2: '«<b>Приватный, передаваемый, и обновляемый</b>» опция означает, что хэши ваших файлов будут подписаны вашим личным ключом и отправлены на выделенный, иерархический, детерминированный аккаунт (HD). Таким образом, никто, кроме Вас, не сможет узнать, какое содержимое было отправлено ',
        ...
        ALERT_MULTISIG_HAS_NO_PUBLIC: 'У мультиаккаунта должна быть хотя бы одна исходящая транзакция для получения публичного ключа!',
        ALERT_COSIG_CANNOT_BE_MULTISIG: 'Выбранный аккаунт является участником другого мультиаккаунта, поэтому не может быть выбран',
        ...
        ALERT_ALREADY_MULTISIG: 'Выбранный аккаунт уже является мультиаккаунтом!',
        ALERT_INVALID_MODIFICATION_ARRAY: 'Мультиаккаунт не может быть соподписантом самого себя, пожалуйста, проверьте список изменений!',
        ALERT_GET_MARKET_INFO_ERROR: 'Произошла ошибка при попытке получить информацию о рынке!',
        ALERT_MULTISIG_CANNOT_BE_COSIG: 'Мультиаккаунт нельзя установить как соподписанта!',
        ...
        ALERT_MULTISIG_MIN_SIGNATURE: 'Мультиаккаунт требует миниммум одну подпись',
        ALERT_BTC_MARKET_ERROR: 'Ошибка при попытке получить цену BTC',
        ALERT_COSIG_REMOVAL_LIMIT: 'Одновременно можно удалить только одного соподписанта',
        ...
        SIGNUP_PRIVATE_KEY_WALLET_WARNING: 'Приватный ключ кошелька использует только пароль, хэшированный несколько раз, поэтому крайне важно выбрать БЕЗОПАСНЫЙ пароль.',
        ...
        SIGNUP_COMMON_WALLET_WARNING_TITLE: 'Предупреждения о безопасности аккаунта',
        SIGNUP_COMMON_WALLET_WARNING_1: 'Кошельки хранятся <b><u>временно</u></b> в локальном хранилище браузера! Браузеры могут быть настроены (например дополнительными расширениями) так, чтобы время от времени очищать локальное хранилище. Это приведёт к потере данных. В нашем случае ваши кошельки исчезнут, поэтому очень важно убедиться, что у Вас есть вся необходимая информация для восстановления Ваших аккаутов.',
        SIGNUP_COMMON_WALLET_WARNING_2: 'Вы должны запустить загрузку после регистрации кошелька. Это файл <b><i>*.wlt</i></b> используемый в качестве резервной копии и импорта обратно, если локальное хранилище Вашего браузер очистится.',
        SIGNUP_COMMON_WALLET_WARNING_3: 'Если Вы не получили файл резервной копии <b><i>*.wlt</i></b>, нажмите кнопку ниже, чтобы открыть данные кошелька и создать файл <b><i>*.wlt</i></b> вручную:',
        SIGNUP_COMMON_WALLET_WARNING_4: 'Даже если у Вас есть файл кошелька, <b><u>обязательно</u></b> сделайте резервную копию приватного ключа Вашего аккаунта. Нажмите кнопку ниже, чтобы показать его:',
        SIGNUP_COMMON_WALLET_WARNING_5: 'Всегда следите за тем, что Вы имеете резервную копию кошелька, прежде чем отправлять какие-либо средства на Ваш счёт.',
        SIGNUP_COMMON_WALLET_WARNING_6: 'Каждый кошелёк имеет <b><u>первичный приватный ключ</u></b> (Ваш показан выше) который используется для создания детерминированных вторичных аккаунтов (BIP32). Это функция требует использования <b><u>того же пароля</u></b> или она будет генерировать разные вторичные аккаунты для того же основного первичного ключа. При резервном копировании данных не забудьте <b><u>записать пароль</u></b> от Вашего кошелька.',
        SIGNUP_COMMON_WALLET_WARNING_BTN_1: 'Показать raw данные кошелька',
        SIGNUP_COMMON_WALLET_WARNING_BTN_1_INFO: 'Чтобы создать файл кошелька, создайте пустой файл и вставьте в него base64 ключ. Нажмите <br>сохранить файл как <b><i>имяВашегоКошелька.wlt</i></b>, и теперь файл можно импортировать.',
        SIGNUP_COMMON_WALLET_WARNING_BTN_2: 'Показать приватный ключ',
        SIGNUP_COMMON_WALLET_WARNING_BTN_2_INFO: 'Чтобы создать резервную копию приватного ключа, сохраните его в текстовом файле, распечатайте или запишите в безопасном месте. <br>Рекомендуется хранить приватный ключ в автономном режиме.',
        SIGNUP_COMMON_WALLET_WARNING_FOOTER: 'Нажав кнопку ниже, Вы соглашаетесь с тем, что Вы прочитали и поняли приведённые выше предупреждения.',
        SIGNUP_COMMON_WALLET_WARNING_CONFIRM_1: 'У меня есть файл кошелька',
        SIGNUP_COMMON_WALLET_WARNING_CONFIRM_2: 'У меня есть приватный ключ',
        SIGNUP_COMMON_WALLET_WARNING_CONFIRM_3: 'Согласен',
        ...
        FORM_PASSPHRASE_CONFIRM: 'Повторите фразу',
