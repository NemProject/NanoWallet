function RussianProvider($translateProvider) {
    ...
    $translateProvider.translations('ru', {
        ...
        HEADER_PURGE_MESSAGE: 'Пожалуйста, подтвердите очистку локального хранилища. По нажатию на кнопку "OK" все сведения о Ваших кошельках в локальном хранилище текущего браузера будут удалены. Пожалуйста, убедитесь в том, что Вы сделали резервную копию всех кошельков для гарантии безопасности Ваших средств.',
        ...
        DASHBOARD_HARVEST_INCOME_TITLE: 'Сбор комиссий с последних 25 блоков',
        ...
        DASHBOARD_MARKET_INFO_CHANGES: 'Изменения в процентах (24ч)',
        ...
        DASHBOARD_NOTICE_3: 'Прежде чем использовать главную сеть (mainnet), команда NEM предлагает в первую очередь поработать с тестовой сетью (testnet), чтобы ознакомиться с NanoWallet. Простое руководство расположено <a href="https://blog.nem.io/nanowallet-tutorial/" target="_blank">здесь</a>. Пользователи несут ответственность за сохранность своих средств, приватных ключей и их резервных копий. Команда NEM не несет ответственности за потерю средств из-за использования этого приложения в главной (mainnet) сети.',
        DASHBOARD_NOTICE_4: 'Мы рекомендуем записывать приватные ключи на бумаге и хранить их в надежном месте. Кроме того, вы можете импортировать свои учетные записи в приложения Android и iOS в качестве резервной копии.',
        ...
        GENERAL_HASH: 'Хеш',
        GENERAL_HASH_FUNCTION: 'Хеш функция',
        GENERAL_NAME: 'Имя',
        ...
        GENERAL_NO: 'Нет',
        GENERAL_TAGS: 'Теги',
        GENERAL_SINK: 'Раковина',
        GENERAL_SINK_ADDRESS: 'Адрес раковины',
        ...
        GENERAL_ACTIVE: 'Активный',
        GENERAL_INACTIVE: 'Неактивный',
        GENERAL_ACTIVATING: "Активация",
        GENERAL_DEACTIVATING: "Деактивация",
        GENERAL_REMOTE: "Удаленный",
        GENERAL_WARNING: 'Предупреждение',
        GENERAL_SCORE: 'Сила',
        GENERAL_LENGTH: 'Длина',
        ...
        TRANSFER_TRANSACTION_HEX_MESSAGE: 'Hex сообщение',
        TRANSFER_TRANSACTION_ENCRYPT_TOOLTIP: 'У получателя нет открытого ключа, видимого в сети',
        TRANSFER_TRANSACTION_ENCRYPT_TOOLTIP_MULTISIG: 'Нет зашифрованных сообщений через мультиподписной аккаунт',
        ...
        LINE_TX_DETAILS_MOS_ATTACHED: 'Прикреплённые мозаики',
        ...
        LINE_TX_DETAILS_MOS_EDIT: 'Редактирование мозаики',
        ...
        IMPORTANCE_TRANSFER_INFO_PART_1: 'После включения транзакции передачи важности в блок, должно пройти 6 часов, чтобы изменения вступили в силу. После этого у вас будет доступ к командам выбора узлов и запуска/остановки',
        ...
        IMPORTANCE_TRANSFER_INFO_PART_MULTISIG: 'Для мультиподписных аккаунтов, только соподписант, который инициировал транзакцию передачи важности, может запускать/останавливать сбор блоков. Если какой-то другой соподписант желает вернуть контроль на сбор блоков, ему просто необходимо деактивировать/актировать удаленный сбор блоков.',
        ...
        IMPORTANCE_TRANSFER_REMOTE_INACTIVE: 'Вы должны отправить транзакцию передачи важности в левой панели, чтобы активировать Ваш удалённый аккаунт.',
        IMPORTANCE_TRANSFER_MULTISIG_NOT_INITIATOR: 'Вы не соподписант, который активировал удаленный аккаунт, поэтому не можете запускать/останавливать делегированный сбор блоков. Пожалуйста, прочитайте информации на вкладке выше, чтобы узнать, как вернуть контроль за сбором блоков',
        ...
        IMPORTANCE_TRANSFER_HARVESTING_STATUS: 'Статус сбора блоков',
        IMPORTANCE_TRANSFER_START_HARVESTING: 'Запустить делегированный сбор блоков',
        IMPORTANCE_TRANSFER_STOP_HARVESTING: 'Остановить делегированный сбор блоков',

        // CREATE MOSAIC MODULE
        MOSAIC_DEFINITION_TITLE: 'Создание мозаики',
        MOSAIC_DEFINITION_NAME: 'Транзакция создания мозаики',
        MOSAIC_DEFINITION_MULTISIG_NAME: 'Мультиподписная транзакция создания мозаики',
        ...
        MOSAIC_DEFINITION_MOSAIC_PROPERTIES: 'Свойства мозаики',
        MOSAIC_DEFINITION_REQUIRES_LEVY: 'Требовать налог',
        MOSAIC_DEFINITION_LEVY_LIMITATION: 'UI-ограничение: в настоящее время в качестве налога допускаются мозаики, находящиеся только в кошельке.',
        MOSAIC_DEFINITION_LEVY_SELECT_MOSAIC: 'Выберите облагаемую налогом мозаику',
        MOSAIC_DEFINITION_LEVY_ADDRESS: 'Номер аккаунта получателя налога',
        ...
        MOSAIC_DEFINITION_INFORMATION_1: 'Максимальная длина имени мозаики составляет 32 символа. Разрешённые символы:',
        ...
        MOSAIC_DEFINITION_INFORMATION_4: 'Поведение мозаики может быть настроено с помощью набора свойства:',
        ...
        MOSAIC_DEFINITION_INFORMATION_6: 'Делимость определяет, до какого десятичного знака мозаику можно разделить. Например, делимость равную 3-м означает, что мозаику можно разделить на мельчайшие части до 0.001 мозаики. Делимость должна быть в диапазоне от 0 до 6.',
        ...
        MOSAIC_DEFINITION_INFORMATION_8: 'Разрешить передачу мозаики между аккаунтами, кроме создателя мозаики. Если свойство \'Передаваемый\' не выбано, то получателем или отправителем может быть только создатель мозаики. Если этот флажок установлен, мозаика можете быть отправлена на любой аккаунт.',
        MOSAIC_DEFINITION_INFORMATION_9: 'Создатель мозаики может совершать специальную комиссию с отправителя и отправлять сборы на аккаунт по своему выбору (таким образом, создатель может указать собственный аккаунт в качестве получателя этой пошлины). Сбор комиссии выглядит следующим образом:',
        MOSAIC_DEFINITION_INFORMATION_10: 'Мозаика использующая сбор. Можно выбрать любую существующую мозаику.',
        MOSAIC_DEFINITION_INFORMATION_11: 'Получатель налога. Это может быть любой аккаунт.',
        ...
        MOSAIC_DEFINITION_INFORMATION_15: 'Плата определяется в процентах и, таким образом, линейно возрастает, в зависимости от количество передаваемых мозаик.',
        MOSAIC_DEFINITION_INFORMATION_16: 'Отправка мозаики в блокчейне NEM требует комиссию. Точная комиссия расчитывается в зависимости от их общего количества и сколько будет отправлено в течении транзакции. За передачу любой <b>мозаики малого бизнеса</b> комиссия составляет 0.05 XEM. Это мозаики с делимостью 0 и количеством ≤ 10000.',

        // EDIT MOSAIC MODULE
        MOSAIC_SUPPLY_CHANGE_TITLE: 'Изменить объём поставки мозаики',
        MOSAIC_SUPPLY_CHANGE_NAME: 'Транзакция изменения объёма поставки мозаики',
        MOSAIC_SUPPLY_CHANGE_MULTISIG_NAME: 'Мультиподписная транзакция изменения объёма поставки мозаики',
        MOSAIC_SUPPLY_CHANGE_SELECT: 'Выбрать мозаику',
        ...
        NAMESPACE_PROVISION_PARENT: 'Родительское пространство имён',
        ...
        NAMESPACE_PROVISION_INFORMATION_2: 'Название части должно начинаться с буквы алфавита или числа, например \'alice\' допустимая часть корневого пространства, в то время как \'_alice\' не допустимо. Некоторые названия зарезервированы, следовательно, не допускаются в качества названия части пространства имён. Среди недопустимых названий частей пространства имён:',
        ...
        RENEW_NS_INFORMATION_4: 'Если пространство имён не продлить во время, все подпространства имён и мозаики, созданые под ним, будут потеряны.',
        ...
        ACCOUNT_HARVESTING_NOTE: 'Узел, используемый для сбора блоков этим аккаунтом, храниться в <b>локальном хранилище вашего браузера</b>. Если хранилище браузера будет очищено, то приложение не сможет узнать какой узел вы использовали и, поэтому <b>статус сбора блоков</b> будет показан как <b>неактивный</b>. В этом случае выберите узел, который вы использовали и статус сбора блоков восстановится автоматически. Если статус не восстановился, проверьте - правильный ли узел вы выбрали. В противном случае это означает, что узел был перезагружен и ваш аккаунт больше не занимается сбором блоков.',
        ...
        ACCOUNT_PRIVATE_KEY_NOTE: 'Ваш приватный ключ хранит всю информацию о Вашем аккаунте. Убедитесь, что он хранится в надёжном месте, где-нибудь <b><u>не в сети</u></b>: пароль зашифрован в .wlt файле, запишите его на листе бумаги, на картинке или скачайте <b><u>QR-код кошелька</u></b>.',
        ...
        ACCOUNT_ADD_NEW_ACCOUNT_WARNING: 'Все аккаунты получены из первичного приватного ключа и пароля с помощью BIP32. Поэтому для получения/воссоздания всех ваших вторичных аккаунтов нужны Ваш первичный приватный ключ и Ваш пароль. <br> Поэтому, <b><u>настоятельно рекомендуется</u></b>, после добавления нового аккаунта сделать новую резеревную копию кошелька, чтобы не пришлось повторять эту операцию еще раз, если локальное хранилище будет очищено.',
        ...
        PORTAL_MULTISIG_TITLE: 'Мультиподписные и Многопользовательские аккаунты',
        ...
        PORTAL_MULTISIG_BTN_3: 'Подписать мультиподписную транзакцию',
        ...
        PORTAL_CHANGELLY_TITLE: 'Сервис мгновенного обмена Changelly',
        PORTAL_CHANGELLY_TEXT: 'Используйте виджет Changelly чтобы приобрести XEM и другие монеты!',
        PORTAL_CHANGELLY_BTN: 'Купить XEM',
        PORTAL_SHAPESHIFT_TITLE: 'Сервис мгновенного обмена ShapeShift',
        PORTAL_SHAPESHIFT_TEXT: 'Используйте виджет ShapeShift чтобы приобрести XEM и другие монеты!',
        PORTAL_SHAPESHIFT_BTN: 'Купить XEM',
        PORTAL_NS_TITLE: 'Пространства имён и подпространства',
        PORTAL_NS_TEXT: 'Пространства имён - это имена доменов. Каждое пространство имён уникально и аутентифицирует мозаики (активы), выпущенные на нём или на его поддоменах.',
        PORTAL_NS_BTN: 'Создать пространство имён',
        PORTAL_MOSAIC_TITLE: 'Мозаики',
        PORTAL_MOSAIC_TEXT: 'Мозаики NEM - это активы, которые раскрывают дополнительные свойства и другие функции. Чтобы иметь возможность создавать мозаики, учётная запись должна взять в аренду хотя бы одно корневое пространство имён.',
        PORTAL_MOSAIC_BTN_1: 'Создать мозаику',
        PORTAL_MOSAIC_BTN_2: 'Редактировать мозаику',
        ...
        EXPLORER_NAV_NSM: 'Пространства имён и мозаики',
        ...
        EXPLORER_HOME_MOSAICS: 'Ваши мозаики',
        EXPLORER_HOME_NS_MULTISIG: 'Мультиподписные владельцы пространств имён',
        EXPLORER_HOME_MOSAICS_LEVY: 'Налог мозаики',

        // EXPLORER NAMESPACES AND MOSAICS
        EXPLORER_NS_MOS_TITLE: 'Обозреватель - Пространства имён и мозаики',
        EXPLORER_NS_MOS_SELECT_MOS: 'Детали выбранной мозаики',
        ...
        EXPLORER_APOSTILLES_PUBLIC: 'Публичные раковины',
        EXPLORER_APOSTILLES_NO_NTY: 'Файл nty не загружен, пожалуйста, нажмите здесь для его импорта.',
        ...
        APOSTILLE_KEEP_PRIVATE: 'Приватный, передаваемый и обновляемый',
        ...
        APOSTILLE_FILE_HASH: 'Хеш файла',
        APOSTILLE_PRIVATE: 'Приватный',
        APOSTILLE_FILENAME: 'Название файла',
        APOSTILLE_NAME_TOO_LONG: 'Имя файла слишком длинное, максимум разрешено 32 символа.',
        ...
        APOSTILLE_INFORMATION_5: 'Для учетных записей в мультиподписном контракте, которые выбрали опцию «Приватный, передаваемый и обновляемый», приватный ключ инициатора соподписей, используется, чтобы подписывать хэш и создавать специальный HD аккаунт, а не аккаунт, который был мультиподписным.',
        ...
        APOSTILLE_NO_NTY: 'Файл nty не загружен, пожалуйста, нажмите здесь для его импорта или он будет создан автоматически.',
        ...
        APOSTILLE_AUDIT_FAIL_NO_PUBLIC_KEY: 'Проверка завершилась неудачей, у владелеца нет публичного ключа!',
        ...
        APOSTILLE_AUDIT_ERROR_SIGNER: 'Произошла ошибка при получении данных подписанта.',
        APOSTILLE_AUDIT_ERROR_SIGNATURE: 'Верификация не удалась, произошла ошибка при проверке подписи!',
        APOSTILLE_AUDIT_INFORMATION_1: 'Файлы, которые могут быть проверены, должны быть в <b>формате apostille</b>',
        APOSTILLE_AUDIT_INFORMATION_2: 'Вы можете распознать их по имени файла:',
        //APOSTILLE_AUDIT_NON_SIGNED: 'Не подписанный пример:',
        //APOSTILLE_AUDIT_SIGNED: 'Подписанный пример:',
        APOSTILLE_AUDIT_FILES: 'Аудит файлов',
        APOSTILLE_AUDIT_FORMAT_EXAMPLE: 'Пример формата Apostille',
        APOSTILLE_AUDIT_REMOVE_RECORDS: 'Удалить локальные записи',

        // APOSTILLE MESSAGE MODULE
        APOSTILLE_MESSAGE_TITLE: 'Отправить сообщение аккаунту нотариального заверения',
        APOSTILLE_MESSAGE_NS_BRAND: 'Использовать моё пространство имён в сообщении бренда',
        ...
        ALERT_COSIGNATORY_HAS_NO_PUBLIC: 'Соподписант должен сделать хотя бы одну исходящую транзакцию для получения публичного ключа!',
        ALERT_MULTISIG_HAS_NO_PUBLIC: 'Мультиподписной аккаунта должен сделать хотя бы одну исходящую транзакцию для получения публичного ключа!',
        ...
        ALERT_NO_NS_OWNED: 'Аккаунт не владеет никаким пространством имён, пожалуйста, создайте его или выберите другой аккаунт',
        ...
        ALERT_INVALID_MOSAIC_NAME: 'Недопустимое имя мозаики!',
        ALERT_MOSAIC_DESCRIPTION: 'Недопустимое описание мозаики!',
        ALERT_GET_INCOMING_TXES_ERROR: 'Произошла ошибка при получении входящих транзакций, причина: ',
        ALERT_GET_MOSAICS_DEFINITIONS_ERROR: 'Ошибка при получении определенной мозаики, причина: ',
        ...
        ALERT_MULTISIG_MIN_SIGNATURE: 'Мультиподписному аккаунту нужна как минимум одна подпись',
        ALERT_BTC_MARKET_ERROR: 'Ошибка при обновлении цены Биткоина',
        ALERT_COSIG_REMOVAL_LIMIT: 'За раз можно удалить только одиного соподписанта',
        ALERT_MULTISIG_MIN_SIGNATURE_INVALID: 'Недопустимое число минимальных подписей',
        ALERT_INSUFFICIENT_BALANCE: 'Недостаточный баланс для выполнения операции',
        ALERT_VOTING_ERROR: 'Недопустимый голос',
        ALERT_BRAIN_PASSWORD_TOO_SHORT: 'Кодовая фраза для Умного кошелька должна быть не менее 40 символов!',
        ALERT_NODE_SEEMS_OFFLINE: 'Похоже, что узел отключен, пожалуйста, выберите другой узел',
        ALERT_WEAK_PASSPHRASE: 'Сила кодовая фразы должна быть не менее 3',
        ALERT_BRAIN_WALLET_UPGRADE: 'Ваш умный кошелек недостаточно защищен! Все умные кошельки должны использовать кодовую фразу, состоящую не менее чем из 40 символов.<br> Мы рекомендуем Вам создать новый кошелек и переместить ваши сбережения в него.<br> Больше информации <a href="https://forum.nem.io/t/2791" target="_blank"><u>здесь</u></a>.',
        ...
        ALERT_VOTING_SUCCESS: 'Голос успешно отправлен',
        ALERT_POLL_CREATION_SUCCESS: 'Голосование успешно создано',

        // CONVERT ACCOUNT TO MULTISIG
        AGGREGATE_MODIFICATION_TITLE: 'Сконвертировать аккаунт в мультиподписной',
        ...
        SIGN_MULTISIG_TRANSACTIONS_TITLE: 'Подписать мультиподписную транзакцию',
        ...
        SIGNUP_CREATE_WALLET_WARNING: 'Пожалуйста, ознакомьтесь с <a href="https://www.w3.org/TR/2014/WD-WebCryptoAPI-20140325/#RandomSource-interface" rel="nofollow" target="_blank"><b>опасностями</b></a> генерирования ключей на стороне клиента; Мы не несём ответственности за любые убытки, которые могут быть связаны с энтропией генерации ключей. Даже если это маловероятно, всё же рекомендуется использовать приватный ключ, сгенерированный клиентом NEM (NCC).',
        SIGNUP_NETWORK_SELECT: 'Сеть',
        SIGNUP_BRAIN_WALLET_WARNING: 'Пожалуйста, ознакомьтесь с <a href="https://en.bitcoin.it/wiki/Brainwallet" rel="nofollow" target="_blank">опасностями</a> генерирования умных кошельков. Умный кошелёк использует ТОЛЬКО пароль, хешированный несколько раз, поэтому крайне важно выбрать БЕЗОПАСНЫЙ пароль, длиной как минимум в 40 символов. <a href="https://xkcd.com/936/" rel="nofollow" target="_blank">XKCD #936</a>',
        SIGNUP_PRIVATE_KEY_WALLET_WARNING: 'Кошелек из приватного ключа для зашифровки импортированного приватного ключа использует ТОЛЬКО пароль, поэтому крайне важно выбрать БЕЗОПАСНЫЙ пароль.',
        SIGNUP_COMMON_WALLET_WARNING_TITLE: 'Предупреждение о безопасности аккаунта',
        SIGNUP_COMMON_WALLET_WARNING_1: 'Кошельки хранятся <a><b>временно</b></a> в локальном хранилище браузера! Браузеры могут быть настроены (например с помощью аддонов) на очистку локального хранилища в заданное время. Это приведёт к потере данных и отменить это будет не просто. В нашем случае пропадут ваши кошельки, поэтому очень важно убедиться, что у вас есть вся необходимая информация для восстановления Ваших аккаунтов.',
        SIGNUP_COMMON_WALLET_WARNING_2: 'Вы должны запустить загрузку резервной копии кошелька. Это файл <b><i>.wlt</i></b>, используемый в качестве резервной копии, и для импорта обратно, если локальное хранилище вашего браузера очистится.',
        SIGNUP_COMMON_WALLET_WARNING_3: 'Если Вы не получили файл <b><i>.wlt</i></b> резервной копии, то нажмите на кнопку ниже, чтобы отобразить исходные данные кошелька и создайте файл вручную:',
        SIGNUP_COMMON_WALLET_WARNING_4: 'Несмотря на то, что у вас есть файл кошелька - <b><u>обязательно</u></b> сделайте резервную копию приватного ключа вашего аккаунта. Нажмите на кнопку ниже, чтобы отобразить его:',
        SIGNUP_COMMON_WALLET_WARNING_5: 'Это ваша ответственность - всегда быть уверенным в сохранности вашего приватного ключа и его резервных копий, прежде чем отправлять средства на Ваш аккаунт.',
        SIGNUP_COMMON_WALLET_WARNING_6: 'Каждый кошелек имеет свой <b><u>первичный приватный ключ</u></b> (Ваш ключ показан выше), который был использован для создания детерминированных вторичных аккаунтов (BIP32). Этой функции необходимо использовать <b><u>такой же пароль</u></b> или она сгенерирует другие вторичные аккаунты для того же первичного приватного ключа. При резервном копировании данных не забудьте <b><u>записать Ваш пароль</u></b>.',
        SIGNUP_COMMON_WALLET_WARNING_BTN_1: 'Показать исходные данные кошелька',
        SIGNUP_COMMON_WALLET_WARNING_BTN_1_INFO: 'Чтобы вручную сделать файл кошелька - создайте пустой текстовый файл и скопируйте в него расположенный выше ключ в формате base 64. <br>Сохраните файл как <b><i>имяВашегоКошелька.wlt</i></b> и теперь его можно импортировать.',
        SIGNUP_COMMON_WALLET_WARNING_BTN_2: 'Показать приватный ключ',
        SIGNUP_COMMON_WALLET_WARNING_BTN_2_INFO: 'Чтобы создать резервную копию приватного ключа, сохраните его в текстовом файле, распечатайте или запишите где-нибудь в безопасном месте. <br>Рекомендуется хранить приватный ключ вне сети.',
        ...
        SIGNUP_COMMON_WALLET_WARNING_CONFIRM_1: 'У меня есть файл моего кошелька',
        SIGNUP_COMMON_WALLET_WARNING_CONFIRM_2: 'У меня есть мой приватный ключ',
        SIGNUP_COMMON_WALLET_WARNING_CONFIRM_3: 'Я согласен',
        SIGNUP_ESTIMATED_PASSPHRASE_STRENGTH: 'Предполагаемая сила кодовой фразы',
        SIGNUP_ESTIMATED_GUESS_TIMES: 'Предполагаемое время подбора',

        // FAQ MODULE
        FAQ_TITLE: 'Часто задаваемые вопросы',
        FAQ_QUESTION_1: 'Как Nano Wallet работает ?',
        FAQ_ANSWER_1: 'Nano Wallet построен на использовании новейших крипто библиотек с ES6 и AngularJS. Это полностью клиентское приложение, которое никогда не отправляет конфиденциальные данные через сеть; все происходит в Вашем браузере - от создания приватных ключей до подписания транзакций.',
        FAQ_QUESTION_2: 'Можно ли его использовать бесплатно ?',
        FAQ_ANSWER_2: 'Абсолютно все операции происходят на стороне клиента, только Вы контролируете свои монеты, нет третьих сторон, и нет дополнительных сборов.',
        FAQ_QUESTION_3: 'Почему у меня сразу есть одна мозаика ?',
        FAQ_ANSWER_3: 'Потому что XEM это валюта по умолчанию в блокчейне NEM и она зарегистрирована в кошельке у каждого пользователя, даже если у него нулевый баланс. Мозаика называется XEM, а ее неймспейс - NEM.',
        FAQ_QUESTION_4: 'Дорожная карта ?',
        FAQ_ANSWER_4: 'В планы текущей дорожной карты входит интеграция всех функций клиента NEM и завершение проектов, финансируемых сообществом, для работы через этот кошелек.',
        FAQ_QUESTION_5: 'Могу ли я получить XEM бесплатно ?',
        FAQ_ANSWER_5: 'Официальных кранов NEM нет, но вы можете поискать неофициальные краны в сети или получить консультацию на форуме NEM и узнать про доступные программы лояльности.',
        FAQ_QUESTION_6: 'Где я могу найти больше информации про NEM ?',
        FAQ_ANSWER_6_FORUM: 'Официальный форум',
        FAQ_ANSWER_6_WEBSITE: 'Официальный веб-сайт',
        FAQ_ANSWER_6_BTT: 'Официальная тема на BitcoinTalk',
        FAQ_QUESTION_7: 'Как поддержать проект ?',
        FAQ_ANSWER_7: 'Nano Wallet поддерживается Quantum_Mechanics и основан на lightwallet от Gimre',
        FAQ_ANSWER_7_2: 'Apostille это сервис, работающий на <a href="http://apostille.nem.io">apostille.nem.io</a> веб-сайте в сотрудничестве с Jabo38 над <a href="https://forum.nem.io/t/nem-apostille-a-nem-notary-system-community-fund-proposal/2001" target="_blank">Apostille проектами</a>.',
        FAQ_ANSWER_7_3: 'Если Вы хотите помочь, не стесняйтесь перейти по адресу выше, спасибо :)',
        FAQ_ANSWER_7_4: 'Фонды проекта NanoWallet:',
        FAQ_ANSWER_7_5: 'Фонды сервиса Apostille:',
        ...
        FORM_ADDRESS_FIELD_PLACEHOLDER: 'Адрес аккаунта',
        ...
        // VOTING MODULE
        PORTAL_VOTING_TITLE: 'Голосование',
        PORTAL_VOTING_TEXT: 'Создай и голосуй на голосовании',
        PORTAL_VOTING_BTN1: 'Увидеть голосования',
        PORTAL_VOTING_BTN2: 'Создать голосование',
        FORM_TITLE_FIELD_PLACEHOLDER: 'Заголовок',
        FORM_DESCRIPTION_FIELD_PLACEHOLDER: 'Напишите ваше описание здесь',
        FORM_OPTION_FIELD_PLACEHOLDER: 'напишите вариант',
        FORM_WHITELIST_FIELD_PLACEHOLDER: 'адрес аккаунта'
    });
