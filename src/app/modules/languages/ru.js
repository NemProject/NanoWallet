function RussianProvider($translateProvider) {
    ...
    $translateProvider.translations('ru', {
        ...
        APP_NAME_SUB: 'Интерфейс безопасного подключения к платформе PROXIMAX',
        ...
        MOSAIC_DEFINITION_INFORMATION_16: 'Отправка мозайки в блокчейне PROXIMAX требует комиссию. Точная комиссия расчитывается в зависимости от их общего количества и сколько будет отправлено в течении транзакции. За передачу любой <b>мозайки малого бизнеса</b> комиссия составляет 0.05 XEM. Это мозайки с делимостью 0 и количеством ≤ 10000.',
        ...
        NAMESPACE_PROVISION_INFORMATION_3: 'Этот список не является окончательным и может быть расширен в будущем. Таким образом, \'user.alice\' или \'alice.user\' не разрешены в системе имён PROXIMAX. Пространство имён может иметь до 3-х частей, например, \'qm.metals.silver\' допустимо, в то время как \'qm.metals.silver.coin\' не допустимо.',
        ...
        ACCOUNT_WALLET_QR_NOTE: 'Этот QR-код будет использоватся для входа в мобильное приложение PROXIMAXpay',
        ...
        PORTAL_MOSAIC_TEXT: 'Мозайки PROXIMAX - это активы, которые раскрывают дополнительные свойства и другие функции. Чтобы иметь возможность создавать мозайки, учётная запись должна зарегистрировать хотя бы одно корневое пространство имён.',
        PORTAL_MOSAIC_BTN_1: 'Создать мозайку',
        PORTAL_MOSAIC_BTN_2: 'Редактировать мозайку',
        PORTAL_APOSTILLE_TITLE: 'Apostille',
        PORTAL_APOSTILLE_TEXT: 'Используйте сервис PROXIMAX Apostille для создания нотариальных заверений на основе технологии «Блокчейн», например для передачи права собственности и проверки документов.',
        ...
        APOSTILLE_INFORMATION_8: 'После отправки транзакции, запускается загрузка архива. Архив содержит ваши подписанные файлы, ваш сертификат Apostille для этого файла и новый или обновленный файл *.nty, чтобы отслеживать каждый файл с вашей временной меткой в PROXIMAX цепочке.',
        ...
        SIGNUP_CREATE_WALLET_WARNING: 'Пожалуйста, ознакомьтесь с <a href="https://www.w3.org/TR/2014/WD-WebCryptoAPI-20140325/#RandomSource-interface" rel="nofollow" target="_blank"><b>опасностями</b></a> генерирования ключей на стороне клиента; Мы не несём ответственности за любые убытки, которые могут быть связаны с энтропией генерации ключей. Даже если это маловероятно, всё же рекомендуется использовать закрытый ключ, сгенерированный клиентом PROXIMAX (NCC).',
        ...
        FAQ_ANSWER_4: 'The current roadmap includes integration of all PROXIMAX client features and completion of community funded projects to work across this wallet.',
