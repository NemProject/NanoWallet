function UkrainianProvider($translateProvider) {
    ...
    $translateProvider.translations('uk', {
        ...
        APP_NAME_SUB: 'Інтерфейс безпечного підключення до платформи PROXIMAX',
        ...
        FOOTER_POWERED_BY_2: 'технології PROXIMAX.',
        ...
        ACCOUNT_WALLET_QR_NOTE: 'Даний QR код використовуватиметься для входу у майбутніх версіях мобільного додатку PROXIMAXpay',
        ...
        PORTAL_MOSAIC_TEXT: 'PROXIMAX мозаїки є активами, які мають додаткові властивості та функції. Щоб мати можливість створювати мозаїки, обліковий запис повинен орендувати щонайменше один головний простір імен.',
        PORTAL_MOSAIC_BTN_1: 'Створити мозаїку',
        PORTAL_MOSAIC_BTN_2: 'Редагувати мозаїку',
        PORTAL_APOSTILLE_TITLE: 'Апостиль',
        PORTAL_APOSTILLE_TEXT: 'Користуйтеся сервісом PROXIMAX Апостиль для створення нотаріальних посвідчень на основі технології блокчейн із тимчасовою міткою, для відстеження прав власності та перевірки автентичності документів.',
        ...
        APOSTILLE_INFORMATION_8: 'Після відправлення транзакцій, відбувається запуск завантаження архіву. Цей архів містить Ваші підписані файли, Ваш сертифікат Апостилю для цього файлу, а також новий чи оновлений файл  .nty для відстеження кожного Вашого файлу, який має Вашу тимчасову мітку у PROXIMAX мережі.',
        ...
        // LOGIN MODULE
        LOGIN_MEMBER_TITLE: 'Чи Ви PROXIMAXber?',
        ...
        // SIGNUP MODULE
        SIGNUP_TITLE: 'Новачок у PROXIMAX?',
        ...
        SIGNUP_NETWORK_MAINNET: 'Mainnet є <b><u>реальною</u></b> PROXIMAX мережею. Адреси починаються з літери \'N\'.',
        SIGNUP_NETWORK_TESTNET: 'Testnet є <b><u>тестовою</u></b> мережею. Адреси починаються з літери \'T\'.',
        SIGNUP_NETWORK_MIJIN: 'Mijin є приватною версією PROXIMAX мережі. Адреси починаються з літери \'M\'.',
        ...
        SIGNUP_CONGRATS_MSG: '<b>Вітаємо!</b> Ваша PROXIMAX адреса',
        ...
        FAQ_ANSWER_3: 'Тому, що XEM є валютою за замовчуванням у блокчейні PROXIMAX, кожен користувач одразу ж має її після реєстрації гаманця, навіть якщо баланс дорівнює 0. Його простором імен є PROXIMAX та назва мозаїки XEM',
        ...
        FAQ_ANSWER_5: 'Кран PROXIMAX зараз неактивний, але Ви можете звернутись з цим питанням на PROXIMAX форумі, щодо наявності доступних баунті винагород.',
        FAQ_QUESTION_6: 'Де я можу знайти більш детальну інформацію про PROXIMAX?',
        ...
        OFFLINE_TX_INFO_2: 'Можливе створення тільки простих транзакцій, тому що для отримання даних про мозаїки і мультипідписної інформації від вузлів PROXIMAX, потрібно з\'єднання з мережею.',
