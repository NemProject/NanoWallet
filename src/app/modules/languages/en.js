function EnglishProvider($translateProvider) {
    ...
    $translateProvider.translations('en', {
        ...
        SIGNUP_COMMON_WALLET_WARNING_BTN_1_INFO: 'To make a wallet file, create an empty text file and put the above base 64 key into it. Save the file as <b><i>yourWalletName.wlt</i></b> and it can now be imported.',
        SIGNUP_COMMON_WALLET_WARNING_BTN_2: 'Show private key',
        SIGNUP_COMMON_WALLET_WARNING_BTN_2_INFO: 'To backup a private key, save it in a text file, print it or write it carefully on paper. It is highly recommend to store the private key in a safe and offline location.',
