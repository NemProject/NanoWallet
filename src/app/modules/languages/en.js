function EnglishProvider($translateProvider) {
    ...
    $translateProvider.translations('en', {
        ...
        NIS_ERR_FAILURE_MESSAGE_TOO_LARGE: 'The message for the transaction exceeds the limit of 512 bytes.',
        NIS_ERR_FAILURE_HASH_EXISTS: 'The hash of the entity already exists either in the cache or in the database.',
        NIS_ERR_FAILURE_SIGNATURE_NOT_VERIFIABLE: 'The signature of the entity failed upon verification.',
        NIS_ERR_FAILURE_TIMESTAMP_TOO_FAR_IN_PAST: 'The timestamp of the entity lies to far in the past.',
        NIS_ERR_FAILURE_TIMESTAMP_TOO_FAR_IN_FUTURE: 'The timestamp of the entity lies too far in the future.',
        NIS_ERR_FAILURE_INELIGIBLE_BLOCK_SIGNER: 'Validation failed because the block had an ineligible signer. This usually occurs when remote harvesting is in the process of being activated or deactivated.',
        NIS_ERR_FAILURE_ENTITY_UNUSABLE_OUT_OF_SYNC: 'The entity cannot be processed because the remote node is out of synchronization with the local node. This happens frequently when a node is not fully synchronized and receives a new block with much larger height than its own chain.',
        NIS_ERR_FAILURE_INSUFFICIENT_FEE: 'The supplied transaction has an insufficient fee.',
        NIS_ERR_FAILURE_NEMESIS_ACCOUNT_TRANSACTION_AFTER_NEMESIS_BLOCK: 'The supplied transaction has the nemesis account as sender and cannot be included in a normal block.',
        NIS_ERR_FAILURE_TRANSACTION_CACHE_TOO_FULL: 'The transaction was rejected because the transaction cache is too full. This happens when an account tries to send too many transactions in a short time. To improve the chance that the transaction gets accepted you can try to raise the transaction fee.',
        NIS_ERR_FAILURE_WRONG_NETWORK: 'Entity was rejected because it has the wrong network specified.',
        NIS_ERR_FAILURE_CANNOT_HARVEST_FROM_BLOCKED_ACCOUNT: 'Block was rejected because it was harvested by a blocked account (typically a reserved NEM fund).',
        NIS_ERR_FAILURE_DESTINATION_ACCOUNT_HAS_NONZERO_BALANCE: 'The importance cannot be transferred to an account with nonzero balance.',
        NIS_ERR_FAILURE_IMPORTANCE_TRANSFER_IN_PROGRESS: 'The transaction is conflicting because there is already a transfer of importance in progress.',
        NIS_ERR_FAILURE_IMPORTANCE_TRANSFER_NEEDS_TO_BE_DEACTIVATED: 'The transaction is conflicting because the importance was already transferred.',
        NIS_ERR_FAILURE_IMPORTANCE_TRANSFER_IS_NOT_ACTIVE: 'The transaction is conflicting because no importance has been transferred yet.',
        NIS_ERR_FAILURE_TRANSACTION_NOT_ALLOWED_FOR_REMOTE: 'Validation failed because transaction is using remote account in an improper way.',
        NIS_ERR_FAILURE_MULTISIG_NOT_A_COSIGNER: 'The multisig transaction was rejected because the signer of the transaction is not a cosignatory of the sender account of the inner transaction.',
        NIS_ERR_FAILURE_MULTISIG_INVALID_COSIGNERS: 'Validation failed because the cosignatories attached to a multisig transaction were invalid.',
        NIS_ERR_FAILURE_MULTISIG_NO_MATCHING_MULTISIG: 'The signature transaction was rejected because the corresponding multisig transaction was not found.',
        NIS_ERR_FAILURE_TRANSACTION_NOT_ALLOWED_FOR_MULTISIG: 'The transaction was rejected because the signer is a multisig account. Multisig accounts are not allowed to initiate any transaction (only cosignatories are allowed to do so).',
        NIS_ERR_FAILURE_MULTISIG_ALREADY_A_COSIGNER: 'The transaction was rejected because it tried to add a cosignatory to a multisig account which already has this cosignatory.',
        NIS_ERR_FAILURE_MULTISIG_MODIFICATION_MULTIPLE_DELETES: 'The transaction was rejected because it tried to remove multiple cosignatories at once. It is only allowed to remove one cosignatory at a time.',
        NIS_ERR_FAILURE_MULTISIG_MODIFICATION_REDUNDANT_MODIFICATIONS: 'The transaction was rejected because it tried to do redundant modifications. This can happen if a transaction tries to add the same cosignatory two time.',
        NIS_ERR_FAILURE_CONFLICTING_MULTISIG_MODIFICATION: 'The transaction was rejected because it contained conflicting modifications to a multisig account. This can for instance happen if a transaction tries to add and then delete the same cosignatory.',
        NIS_ERR_FAILURE_TOO_MANY_MULTISIG_COSIGNERS: 'The transaction was rejected because it contains too many cosignatories. The maximum number of cosignatories allowed for a multisig account is 32.',
        NIS_ERR_FAILURE_MULTISIG_ACCOUNT_CANNOT_BE_COSIGNER: 'Validation failed because a multisig modification would result in a multisig account being a cosigner.',
        NIS_ERR_FAILURE_MULTISIG_MIN_COSIGNATORIES_OUT_OF_RANGE: 'Validation failed because the minimum number of cosignatories is negative or larger than the number of cosignatories.',
        NIS_ERR_FAILURE_NAMESPACE_UNKNOWN: 'Validation failed because the namespace is unknown.',
        NIS_ERR_FAILURE_NAMESPACE_ALREADY_EXISTS: 'Validation failed because the namespace already exists.',
        NIS_ERR_FAILURE_NAMESPACE_EXPIRED: 'Validation failed because the namespace has expired.',
        NIS_ERR_FAILURE_NAMESPACE_OWNER_CONFLICT: 'Validation failed because the transaction signer is not the owner of the namespace.',
        NIS_ERR_FAILURE_NAMESPACE_INVALID_NAME: 'Validation failed because the name for the namespace is invalid.',
        NIS_ERR_FAILURE_NAMESPACE_INVALID_RENTAL_FEE_SINK: 'Validation failed because the specified namespace rental fee sink is invalid.',
        NIS_ERR_FAILURE_NAMESPACE_INVALID_RENTAL_FEE: 'Validation failed because the specified rental fee is invalid.',
        NIS_ERR_FAILURE_NAMESPACE_PROVISION_TOO_EARLY: 'Validation failed because the provision was done too early.',
        NIS_ERR_FAILURE_NAMESPACE_NOT_CLAIMABLE: 'Validation failed because the namespace contains a reserved part and is not claimable.',
        NIS_ERR_FAILURE_MOSAIC_UNKNOWN: 'Validation failed because the mosaic is unknown.',
        NIS_ERR_FAILURE_MOSAIC_MODIFICATION_NOT_ALLOWED: 'Validation failed because the modification of the existing mosaic is not allowed.',
        NIS_ERR_FAILURE_MOSAIC_CREATOR_CONFLICT: 'Validation failed because the transaction signer is not the creator of the mosaic.',
        NIS_ERR_FAILURE_MOSAIC_SUPPLY_IMMUTABLE: 'Validation failed because the mosaic supply is immutable.',
        NIS_ERR_FAILURE_MOSAIC_MAX_SUPPLY_EXCEEDED: 'Validation failed because the maximum overall mosaic supply is exceeded.',
        NIS_ERR_FAILURE_MOSAIC_SUPPLY_NEGATIVE: 'Validation failed because the resulting mosaic supply would be negative.',
        NIS_ERR_FAILURE_MOSAIC_NOT_TRANSFERABLE: 'Validation failed because the mosaic is not transferable.',
        NIS_ERR_FAILURE_MOSAIC_DIVISIBILITY_VIOLATED: 'Validation failed because the divisibility of the mosaic is violated.',
        NIS_ERR_FAILURE_CONFLICTING_MOSAIC_CREATION: 'Validation failed because conflicting mosaic creation is present.',
