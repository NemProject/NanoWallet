function EnglishProvider($translateProvider) {
    ...
    $translateProvider.translations('en', {
        ...
        FORM_TITLE_FIELD_TITLE: 'Title',
        FORM_TITLE_FIELD_PLACEHOLDER: 'Title',
        FORM_DESCRIPTION_FIELD_TITLE: 'Description',
        FORM_DESCRIPTION_FIELD_PLACEHOLDER: 'Write your description here',
        FORM_OPTION_FIELD_TITLE: 'Options',
        FORM_OPTION_FIELD_PLACEHOLDER: 'write option',
        FORM_WHITELIST_FIELD_TITLE: 'Whitelist',
        FORM_WHITELIST_FIELD_EXPLAIN: 'Only addresses in the Whitelist will be able to vote.',
        FORM_WHITELIST_FIELD_PLACEHOLDER: 'account address',
        FORM_MOSAIC_FIELD_TITLE: 'Mosaic',
        FORM_MOSAIC_FIELD_EXPLAIN: 'Only addresses with this Mosaic will be able to vote.',
        POLL_FORM_TITLE: 'Create a Poll',
        FORM_INDEX_ACCOUNT_FIELD_TITLE: 'Poll Index Account',
        FORM_INDEX_ACCOUNT_FIELD_EXPLAIN: 'The poll account where the poll will be saved. By default a public one is set.',
        FORM_DATEOFENDING_FIELD_TITLE: 'Date of Ending',
        FORM_DATEOFENDING_FIELD_EXPLAIN: 'If you only see a text box input a date in a valid ISO format [yyyy-MM-ddTHH:mm], for example: 2017-12-28T14:57',
        FORM_MULTIPLECHOICE_FIELD_TITLE: 'Multiple choice',
        FORM_MULTIPLECHOICE_FIELD_EXPLAIN: 'If selected Voters will be able to divide their vote into more than one option.',
        FORM_TYPE_FIELD_TITLE: 'Type',
        FORM_TYPE_FIELD_EXPLAIN_POI: 'POI: votes will be weighted against the Proof of Importance of the voting account.',
        FORM_TYPE_FIELD_EXPLAIN_WHITELIST: 'White List Poll: Only addresses in the whitelist can vote. All votes count the same.',
        SPINNER_MESSAGE: 'Creating...',
        MESSAGE_TITLE_TOO_LONG: 'Title too long',
        MESSAGE_DESCRIPTION_TOO_LONG: 'Description too long',
        MESSAGE_OPTIONS_TOO_LONG: 'too many options / options too long',
        MESSAGE_WHITELIST_TOO_LONG: 'Whitelist too long',
        BUTTON_LABEL_CREATE: 'Create',
        PORTAL_POLLS_TITLE: 'Vote and See Polls',
        PORTAL_POLLS_ALL: 'All',
        PORTAL_POLLS_ONGOING: 'Ongoing',
        PORTAL_POLLS_ENDED: 'Ended',
        PORTAL_POLLS_OPTIONS: 'Options',
        PORTAL_POLLS_SEARCH_POLL_OR_INNDEX: 'Search for a poll or a poll Index:',
        PORTAL_POLLS_SEARCH_POLL_OR_INNDEX_EXPLAIN: 'You can find a specific poll or index by typing the address for the poll account or the poll index account in the bar and clicking on the appropriate search button.',
        PORTAL_POLLS_FIND_POLL: 'Find Poll',
        PORTAL_POLLS_FIND_INDEX: 'Find Index',
        PORTAL_POLLS_NOT_VALID_ADDRESS: 'Not a valid Address',
        PORTAL_POLLS_ADDRESS_ERROR: 'There was an error. Make sure the address is correct',
        PORTAL_POLLS_SHOW_ONLY_POLLS_VOTE: 'Show only polls you can vote on',
        PORTAL_POLLS_CREATE_POLL_INDEX: 'Create a poll Index',
        PORTAL_POLLS_CREATED_INDEXES: 'created Indexes',
        PORTAL_POLLS_POLL_ADDRESS: 'Poll Address',
        PORTAL_POLLS_DATE_OF_ENDING: 'Date of ending',
        PORTAL_POLLS_VOTE: 'Vote',
        PORTAL_POLLS_RESULTS: 'Results',
        PORTAL_POLLS_EXPLAIN_MULTI_ANSWER: 'This is a multiple answer Poll. You can divide your vote into different options.',
        PORTAL_POLLS_VOTING_HAS_FEE: 'Voting has a fee of',
        PORTAL_POLLS_XEM_PER_OPTION: 'XEM per option',
        PORTAL_POLLS_CREATE_SUCCESS: 'You have successfully Voted on this Poll',
        PORTAL_POLLS_UNCONFIRMED_VOTE: 'You have an unconfirmed Vote on this Poll',
        PORTAL_POLLS_POLL_ENDED: 'This poll has ended',
        PORTAL_POLLS_POLL_NOT_FINISHED: 'This poll has not finished yet, the results are not definitive.',
        PORTAL_POLLS_VOTES: 'votes',
        PORTAL_POLLS_WEIGHTED_SCORE: 'weighted score',
        PORTAL_POLLS_PERCENTAGE: 'percentage',
        PORTAL_POLLS_WEIGHTED_EXPLAIN1: 'Weighted score varies depending on the type of vote',
        PORTAL_POLLS_WEIGHTED_EXPLAIN2: 'for whitelist polls it is the same as the votes',
        PORTAL_POLLS_WEIGHTED_EXPLAIN3: 'for POI polls it is the sum of importances of the voters multiplied by 100',
        PORTAL_POLLS_CREATE_EXPLAIN1: 'This action will create a new poll Index. When you create a new Poll you can choose the index it is submitted to, and on the voting module you can change the index you view polls from.',
        PORTAL_POLLS_CREATE_EXPLAIN2: 'When you create a new Index a new NEM account is generated, a message will be sent to your address with a message containing the created Index. Write down the address to create and see polls stored on it. Index creation has a fee of',
        PORTAL_POLLS_CREATE_EXPLAIN3: 'For private Indexes only the creator of the index will be able to send polls. But everybody will be able to see and vote on its polls if they have importance or are on the whitelist for simple polls.',
        PORTAL_POLLS_CREATE_PRIVATE_INDEX: 'Create private Index',
        PORTAL_POLLS_ERROR_FETCHING_POLL: 'There was an error fetching the poll. The poll does not exist, or was not created properly.'
